    ...
    <div class="intro-text large-section np-bottom grid-container np-mobile epcl-flex">
        <div class="left grid-50 tablet-grid-55">
            ...
            <form class="subscribe-form" data-members-form="subscribe">
                ...
                <div class="form-group">
                    <input id="subscribe-email" type="email" name="email" class="inputbox large"
                        required="" placeholder="Enter your email address" data-members-email="">
        ...
        <div class="right grid-45 tablet-grid-45 mobile-grid-60">
            <img src="{{ asset('assets') }}/image/about.webp" fetchpriority="high" decoding="async"
                alt="" class="hero-image fullwidth" width="442" height="442">
        </div>
    </div>
    <!-- end: .intro-text -->