<div class="epcl-demo-tool hide-on-mobile hide-on-tablet hide-on-desktop-sm">
    ...
    <label><input type="color" value="#FAF8FF" data-class="body" data-attr="background"> Background
        Color</label>
    <label><input type="color" value="#E9E8FF" data-target="--epcl-boxes-border-color"> Boxes Border
        Color</label>
