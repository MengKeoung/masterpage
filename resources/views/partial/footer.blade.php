...
<footer id="footer">
                    ...
                    <li>
                        <a href="https://github.com/estudiopatagon" class="github" target="_blank">
                            ...
                            <span class="icon"><svg class="icon">
                                    <use xlink:href="/zento/assets/images/svg-icons.svg?v=1b89f44b98#github-icon">
                                    </use>
                                </svg></span>
                        </a>
                    </li>
    ...
    <p class="published underline-effect"><a href="https://estudiopatagon.com/projects/zento-for-ghost/"
            ...
            target="_blank">EstudioPatagon</a> <span class="dot"></span> Powered by <a
            href="https://ghost.org/" target="_blank">Ghost</a></p>
    <div class="clear"></div>
